...
public class SOnLadderStateX : SPlayerMoveX
{
    float v;
    public SOnLadderStateX(CPlayerController controller, LadderPos ladderPos, float ladderStep) : base(controller)
    {
        SOnLadderStateX.ladderPos = ladderPos;
        SOnLadderStateX.ladderStep = ladderStep;
    }
